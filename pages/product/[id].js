                ...
                <div className="lg:w-4/5 mx-auto flex flex-wrap items-center justify-center">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex">
                            ...
                            <button className="ml-auto text-white bg-myorange border-0 py-2 px-4 focus:outline-none hover:bg-darkorange rounded" onClick={() => { editCart('add', id, price, name, size.current.value) }}>Add to cart</button>
