        ...
        <section className="text-gray-600 body-font overflow-hidden">
            <div className="container px-5 py-16 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap items-center justify-center">
                    <img alt="ecommerce" className="w-1/2 sm:w-1/3 xl:w-1/4 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/51lSbxUm5YL._UL1500_.jpg" />
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                            <div className="flex">
                                ...
                                <button className="border-2 border-gray-300 ml-1 bg-myorange rounded-full w-6 h-6 focus:outline-none"></button>
                            </div>
                            <div className="flex ml-6 items-center">
                                <span className="mr-3">Size</span>
                                <div className="relative">
                                    <select className="rounded border appearance-none py-2 focus:outline-none focus:border-myorange text-base pl-3 pr-10">
                                        <option>SM</option>
                                        <option>M</option>
                                        <option>L</option>
                                        <option>XL</option>
                        ...
                        <div className="flex">
                            ...
                            <button className="ml-auto text-white bg-myorange border-0 py-2 px-4 focus:outline-none hover:bg-darkorange rounded" onClick={() => { editCart('add', product, 499, 'T-Shirt', 'M') }}>Add to cart</button>
